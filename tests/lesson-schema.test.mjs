...
test("complete lessons satisfy the standard lesson definition", async () => {
  ...
  try {
    ...
    const countingModule = await server.ssrLoadModule("/lib/lessons/counting-sort.ts");
    ...
    const radixModule = await server.ssrLoadModule("/lib/lessons/radix-sort.ts");
    ...
    const lessons = [bubbleModule.bubbleSortLesson, selectionModule.selectionSortLesson, insertionModule.insertionSortLesson, mergeModule.mergeSortLesson, quickModule.quickSortLesson, heapModule.heapSortLesson, countingModule.countingSortLesson, radixModule.radixSortLesson];
