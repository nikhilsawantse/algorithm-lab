...
const routes = ["/", "/sorting/bubble-sort", "/sorting/selection-sort", "/sorting/insertion-sort", "/sorting/merge-sort", "/sorting/quick-sort", "/sorting/heap-sort", "/sorting/counting-sort", "/sorting/radix-sort", "/glossary"];
